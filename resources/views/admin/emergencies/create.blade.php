    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ __('Add Emergency') }}</h5></li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{  __('Add Emergency') }} </a></li>
            </ol>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="offcanvas-body">
                                <div class="container-fluid">
                                <h4 class="heading mb-0"> {{ __('Add Emergency') }}</h4>

                            <form method="POST" action="{{ route('admin.emergencies.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-xl-8 mb-3">
                                        <label for="exampleFormControlInputfirst" class="form-label">Entity responsible (En)<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="exampleFormControlInputfirst" name="agency_en" value="{{ old('agency_en') }}">
                                        @error('agency_en')
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInputfirst" name="agency_ar" value="{{ old('agency_ar') }}">
                                        @error('agency_ar')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-xl-8 mb-3">
                                       ...
                                       <div class="col-xl-8 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInputfirst" name="agency_ru" value="{{ old('agency_ru') }}">
