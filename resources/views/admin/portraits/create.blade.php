    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ __('Add Portrait images') }}</h5></li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{  __('Add Portrait images') }} </a></li>
            </ol>
            <a class="text-primary fs-13" href="{{ route('admin.portraits.index') }}" >{{  __('Portrait images') }}</a>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="offcanvas-body">
                                <div class="container-fluid">
                                <h4 class="heading mb-0"> {{ __('Add Portrait images') }}</h4>
                                <x-admin-layouts.alerts />

                            <form method="POST" action="{{ route('admin.portraits.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
