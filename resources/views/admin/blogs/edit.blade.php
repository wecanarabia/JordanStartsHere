                                ...
                                <div class="row">
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="notsuggested" type="radio" name="slider_status" value="0" @checked(old('slider_status',$blog->slider_status)==0)>
                                                <label class="form-check-label" for="notsuggested">
                                                    Hidden
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" id="suggested" type="radio" name="slider_status" value="1" @checked(old('slider_status',$blog->slider_status)==1)>
