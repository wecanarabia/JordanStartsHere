    ...
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('Areas') }} </a></li>
            </ol>
            <a class="text-primary fs-13" href="{{ route('admin.areas.create') }}">+ Add Area</a>
        </div>
                                                                ...
                                                                @forelse ($data as $area)
                                                                    <tr>
                                                                        ...
                                                                        <td class="align-center">
                                                                            ...
                                                                            <a
                                                                                href="{{ route('admin.areas.sort', ['id' => $area->id, 'direction' => 'down']) }}">
                                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                                    width="22" height="22"
                                                                                    viewBox="0 0 24 24" fill="none"
                                                                                    stroke="#000" stroke-width="1"
                                                                            ...
                                                                            <div class="dropdown">
                                                                                ...
                                                                                <div class="dropdown-menu">
                                                                                    ...
                                                                                    <button class="dropdown-item"
                                                                                        ...
                                                                                        data-id="{{ $area->id }}"
                                                                                        data-name="{{ $area->name }}">Delete</button>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.areas.destroy', 'test') }}" method="post">
                    {{ method_field('delete') }}
                    @csrf
