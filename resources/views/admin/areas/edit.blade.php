    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ __('Edit Area') }}</h5></li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{  __('Edit Area') }} </a></li>
            </ol>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="offcanvas-body">
                                <div class="container-fluid">
                                <h4 class="heading mb-0"> {{ __('Edit Area') }}</h4>
                            ...
                            <form method="POST" action="{{ route("admin.areas.update",$area->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-xl-8 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="exampleFormControlInputfirst" name="name_ru" value="{{ old('name_ru',$area->getTranslation('name','ru')) }}">
