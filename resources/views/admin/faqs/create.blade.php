                            ...
                            <form method="POST" action="{{ route('admin.faqs.store') }}">
                                ...
                                <div class="row">
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInputfirst" name="question_en" placeholder="English Title" value="{{ old('question_en') }}">
                                        @error('question_en')
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInputsecond" name="question_ar" placeholder="Arabic Title" value="{{ old('question_ar') }}">
                                        @error('question_ar')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <div class="card-body custom-ekeditor">
                                            <textarea id="ckeditor" class="form-txtarea form-control" rows="8" name="answer_en">{{ old('answer_en') }}</textarea>
                                        </div>
                                        @error('answer_en')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
