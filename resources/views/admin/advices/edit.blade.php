    ...
    ***********************************-->
    <div class="content-body">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                <li><h5 class="bc-title">{{ __('Edit Advice') }}</h5></li>
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">{{  __('Edit Advice') }} </a></li>
            </ol>
            <a class="text-primary fs-13" href="{{ route('admin.advices.index') }}" >{{  __('Advices') }}</a>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="offcanvas-body">
                                <div class="container-fluid">
                                <h4 class="heading mb-0"> {{ __('Edit Advice') }}</h4>

                            <form method="POST" action="{{ route("admin.advices.update",$advice->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <textarea id="ckeditor" class="form-txtarea form-control" rows="8" name="body_en">{{ old('body_en',$advice->getTranslation('body','en')) }}</textarea>
                                        </div>
                                        @error('body_en')
                                    ...
                                    <div class="col-xl-8 mb-3">
                                        ...
                                        <div class="card-body custom-ekeditor">
                                        <textarea id="ckeditor1" class="form-txtarea form-control" rows="8" name="body_ar">{{ old('body_ar',$advice->getTranslation('body','ar')) }}</textarea>
                                        </div>
                                        @error('body_ar')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
