            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ route('admin.reviews.index') }}" class="" href="javascript:void(0);" aria-expanded="false">
                      ...
                      <li><a href="{{ route('admin.ads.show') }}" class="" href="javascript:void(0);" aria-expanded="false">
						<div class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#888" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.2 15c.7-1.2 1-2.5.7-3.9-.6-2-2.4-3.5-4.4-3.5h-1.2c-.7-3-3.2-5.2-6.2-5.6-3-.3-5.9 1.3-7.3 4-1.2 2.5-1 6.5.5 8.8M12 19.8V12M16 17l-4 4-4-4"/></svg>
                        </div>
						<span class="nav-text">Panner Ad</span>
						</a>
                    ...
                    <li><a href="{{ route('admin.areas.index') }}" class="" href="javascript:void(0);" aria-expanded="false">
						<div class="menu-icon">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#888888" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s-8-4.5-8-11.8A8 8 0 0 1 12 2a8 8 0 0 1 8 8.2c0 7.3-8 11.8-8 11.8z"/><circle cx="12" cy="10" r="3"/></svg>						</div>
                    ...
                    @can('enterprises')
                    <li>
                        <a  href="{{ route('admin.enterprises.index') }}" aria-expanded="false">
                            <div class="menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#888888" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M21.5 12H16c-.7 2-2 3-4 3s-3.3-1-4-3H2.5"/><path d="M5.5 5.1L2 12v6c0 1.1.9 2 2 2h16a2 2 0 002-2v-6l-3.4-6.9A2 2 0 0016.8 4H7.2a2 2 0 00-1.8 1.1z"/></svg>
                            </div>
                    ...
                    @endcan
                    @can('tags')
                    <li><a href="{{ route('admin.tags.index') }}" class=""  aria-expanded="false">
						<div class="menu-icon">
